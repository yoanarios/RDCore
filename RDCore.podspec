...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://github.com/yoanarios/RDCore"
  ...
  # Or just: spec.author    = "Yoana Rios"
  # spec.authors            = { "Yoana Rios" => "yrrios13@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Yoana Rios"
